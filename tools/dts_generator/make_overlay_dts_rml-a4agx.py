...
def build_cameras(camera_list: Iterable[camera.Type], gmsl_dsers: Iterable[DeviceTreeNode]) -> List[camera.Camera]:
    ...
    c1mp_cameras = [
        camera.C1MP(index=0, suffix='b', address='1c', vc_id='1', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='b', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_c"),
        camera.C1MP(index=1, suffix='a', address='1b', vc_id='0', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='a', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_c"),
        camera.C1MP(index=2, suffix='d', address='1c', vc_id='1', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='b', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_a"),
        camera.C1MP(index=3, suffix='c', address='1b', vc_id='0', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='a', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_a"),
        camera.C1MP(index=4, suffix='f', address='1c', vc_id='1', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='b', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_g"),
        camera.C1MP(index=5, suffix='e', address='1b', vc_id='0', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='a', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_g"),
        camera.C1MP(index=6, suffix='h', address='1c', vc_id='1', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='b', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_e"),
        camera.C1MP(index=7, suffix='g', address='1b', vc_id='0', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='a', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_e"),
    ]

    c2mp_cameras = [
        camera.C2MP(index=0, suffix='b', address='2c', vc_id='1', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='b', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_c"),
        camera.C2MP(index=1, suffix='a', address='2b', vc_id='0', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='a', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_c"),
        camera.C2MP(index=2, suffix='d', address='2c', vc_id='1', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='b', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_a"),
        camera.C2MP(index=3, suffix='c', address='2b', vc_id='0', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='a', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_a"),
        camera.C2MP(index=4, suffix='f', address='2c', vc_id='1', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='b', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_g"),
        camera.C2MP(index=5, suffix='e', address='2b', vc_id='0', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='a', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_g"),
        camera.C2MP(index=6, suffix='h', address='2c', vc_id='1', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='b', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_e"),
        camera.C2MP(index=7, suffix='g', address='2b', vc_id='0', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='a', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_e"),
    ]
    
    c3mp_cameras = [
        camera.C3MP(index=0, suffix='b', address='3c', vc_id='1', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='b', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_c"),
        camera.C3MP(index=1, suffix='a', address='3b', vc_id='0', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='a', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_c"),
        camera.C3MP(index=2, suffix='d', address='3c', vc_id='1', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='b', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_a"),
        camera.C3MP(index=3, suffix='c', address='3b', vc_id='0', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='a', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_a"),
        camera.C3MP(index=4, suffix='f', address='3c', vc_id='1', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='b', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_g"),
        camera.C3MP(index=5, suffix='e', address='3b', vc_id='0', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='a', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_g"),
        camera.C3MP(index=6, suffix='h', address='3c', vc_id='1', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='b', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False, tegra_sinterface="serial_e"),
        camera.C3MP(index=7, suffix='g', address='3b', vc_id='0', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='a', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True,  tegra_sinterface="serial_e"),
    ]
...
gmsl_dsers_nodes_tier4 = [
    ...
    gmsl.Deserializer.node(name='max9296', csi_lanes=CSI_LANES, label='dserd')
        .properties([
            f'reset-gpios = <&gpio 0xa0 {const.GPIO_ACTIVE_LOW}>',
            'fsync-gpi = <6>'
        ]),
]

gmsl_dsers_nodes_tier4mp = [
    gmsl.Tier4MPDeserializer.node(name='max9296', csi_lanes=CSI_LANES, label='dsera')
        .properties([
            f'reset-gpios = <&gpio 59 0>', # TEGRA234_MAIN_GPIO(H, 3) = 7*8+3 = 59 (refer: https://github.com/analogdevicesinc/linux/blob/main/include/dt-bindings/gpio/tegra234-gpio.h) 
            'fsync-gpi = <6>'
        ]),
    gmsl.Tier4MPDeserializer.node(name='max9296', csi_lanes=CSI_LANES, label='dserb')
        .properties([
            f'reset-gpios = <&gpio 161 0>', # TEGRA234_MAIN_GPIO(AC, 1) = 20*8+1 = 161 (refer: https://github.com/analogdevicesinc/linux/blob/main/include/dt-bindings/gpio/tegra234-gpio.h) 
            'fsync-gpi = <6>'
        ]),
    gmsl.Tier4MPDeserializer.node(name='max9296', csi_lanes=CSI_LANES, label='dserc')
        .properties([
            f'reset-gpios = <&gpio 113 0>', # TEGRA234_MAIN_GPIO(P, 1) = 14*8+1 = 113 (refer: https://github.com/analogdevicesinc/linux/blob/main/include/dt-bindings/gpio/tegra234-gpio.h)
            'fsync-gpi = <6>'
        ]),
    gmsl.Tier4MPDeserializer.node(name='max9296', csi_lanes=CSI_LANES, label='dserd')
        .properties([
            f'reset-gpios = <&gpio 0xa0 {const.GPIO_ACTIVE_LOW}>',
            'fsync-gpi = <6>'
        ]),
...
def generate_jetson_camera_overlay(opts: GeneratorOptions) -> DeviceTreeNode:
    ...
    # create gmsl_dsers_nodes
    gmsl_dsers_nodes = list()
    for i, cam in enumerate(opts.camera_list[::2]):
        if cam.is_tier4mp:
            gmsl_dsers_nodes.append(gmsl_dsers_nodes_tier4mp[i])
        else:
            gmsl_dsers_nodes.append(gmsl_dsers_nodes_tier4[i])
    ...
    if opts.l4t_version.major >= 36:
        ...
        with open(TEGRA_CAMERA_BASE_OVERLAY_R36, 'r', encoding='utf-8') as tegra_cam_dtsi:
            dtsi_content = tegra_cam_dtsi.read()

            # For vi_port 1, 3, 5, 7, ensure vc-id is 1
            # This regex finds a vi_portX block and replaces the vc-id inside it.
            for port_num in [1, 3, 5, 7]:
                dtsi_content = re.sub(
                    fr'(vi_port{port_num}\b.*?endpoint.*?\{{.*?vc-id\s*=\s*)<.*?>',
                    r'\g<1><1>',
                    dtsi_content,
                    flags=re.DOTALL
                )
