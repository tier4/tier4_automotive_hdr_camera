#!/usr/bin/env python3
"""
Jetson camera devicetree overlay generator for Vecow EAC-5000 (R36).
Refined based on otocam_isx021_orig.dts structure.
"""
...
# PIXEL_CLOCK_IMX728: int = 625000000
...
def build_cameras(camera_list: Iterable[camera.Type], gmsl_dsers: Iterable[DeviceTreeNode]) -> List[camera.Camera]:
    ...
    c1mp_cameras = [
        camera.C1MP(index=0, suffix='b', address='1c', vc_id='1', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='b', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C1MP(index=1, suffix='a', address='1b', vc_id='0', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='a', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
        camera.C1MP(index=2, suffix='d', address='1c', vc_id='1', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='b', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C1MP(index=3, suffix='c', address='1b', vc_id='0', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='a', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
        camera.C1MP(index=4, suffix='f', address='1c', vc_id='1', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='b', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C1MP(index=5, suffix='e', address='1b', vc_id='0', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='a', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
        camera.C1MP(index=6, suffix='h', address='1c', vc_id='1', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='b', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C1MP(index=7, suffix='g', address='1b', vc_id='0', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='a', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
    ]

    c2mp_cameras = [
        camera.C2MP(index=0, suffix='b', address='2c', vc_id='1', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='b', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C2MP(index=1, suffix='a', address='2b', vc_id='0', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='a', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
        camera.C2MP(index=2, suffix='d', address='2c', vc_id='1', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='b', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C2MP(index=3, suffix='c', address='2b', vc_id='0', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='a', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
        camera.C2MP(index=4, suffix='f', address='2c', vc_id='1', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='b', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C2MP(index=5, suffix='e', address='2b', vc_id='0', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='a', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
        camera.C2MP(index=6, suffix='h', address='2c', vc_id='1', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='b', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C2MP(index=7, suffix='g', address='2b', vc_id='0', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='a', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
    ]

    c3mp_cameras = [
        camera.C3MP(index=0, suffix='b', address='3c', vc_id='1', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='b', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C3MP(index=1, suffix='a', address='3b', vc_id='0', csi_lanes=CSI_LANES, port_index=0, serdes_csi_link='a', dser_label=dser_label[0], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
        camera.C3MP(index=2, suffix='d', address='3c', vc_id='1', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='b', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C3MP(index=3, suffix='c', address='3b', vc_id='0', csi_lanes=CSI_LANES, port_index=2, serdes_csi_link='a', dser_label=dser_label[1], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
        camera.C3MP(index=4, suffix='f', address='3c', vc_id='1', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='b', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C3MP(index=5, suffix='e', address='3b', vc_id='0', csi_lanes=CSI_LANES, port_index=4, serdes_csi_link='a', dser_label=dser_label[2], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
        camera.C3MP(index=6, suffix='h', address='3c', vc_id='1', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='b', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=False),
        camera.C3MP(index=7, suffix='g', address='3b', vc_id='0', csi_lanes=CSI_LANES, port_index=6, serdes_csi_link='a', dser_label=dser_label[3], serdes_pix_clk_hz=PIXEL_CLOCK, primary=True),
    ]
...
def create_gmsl_dser_nodes(use_tier4mp_per_dser: Optional[List[bool]] = None) -> List[DeviceTreeNode]:
    """Create GMSL deserializer nodes with appropriate compatible strings and GPIOs."""
    if use_tier4mp_per_dser is None:
        use_tier4mp_per_dser = [False, False, False, False]

    dser_configs = [
        ('max9296_a', 'dsera', f'reset-gpios = <&gpio 0x3e {const.GPIO_ACTIVE_LOW}>'),
        ('max9296_c', 'dserb', f'reset-gpios = <&gpio 0xa0 {const.GPIO_ACTIVE_LOW}>'),
        ('max9296_e', 'dserc', f'reset-gpios = <&gpio 0x3b {const.GPIO_ACTIVE_LOW}>'),
        ('max9296_g', 'dserd', f'reset-gpios = <&gpio 0xa1 {const.GPIO_ACTIVE_LOW}>'),
    ]
...
def generate_jetson_camera_overlay(opts: GeneratorOptions) -> DeviceTreeNode:
    ...
    i2c_bus_number_base: int = 0x09
    i2c_bus_path = '/bus@0/i2c@3180000'
    ...
    tegra_camera_platform_modules = [
        CameraPlatform.module_fragment(opts, index=0, cam=at(cameras, 1), position='front',  i2c_bus_number=i2c_bus_number_base + 0, i2c_bus_path=f'{i2c_bus_path}/tca9543@72/i2c@0'),
        CameraPlatform.module_fragment(opts, index=1, cam=at(cameras, 0), position='rear',   i2c_bus_number=i2c_bus_number_base + 0, i2c_bus_path=f'{i2c_bus_path}/tca9543@72/i2c@0'),
        CameraPlatform.module_fragment(opts, index=2, cam=at(cameras, 3), position='right',  i2c_bus_number=i2c_bus_number_base + 1, i2c_bus_path=f'{i2c_bus_path}/tca9543@72/i2c@1'),
        CameraPlatform.module_fragment(opts, index=3, cam=at(cameras, 2), position='left',   i2c_bus_number=i2c_bus_number_base + 1, i2c_bus_path=f'{i2c_bus_path}/tca9543@72/i2c@1'),
        CameraPlatform.module_fragment(opts, index=4, cam=at(cameras, 5), position='right2', i2c_bus_number=i2c_bus_number_base + 2, i2c_bus_path=f'{i2c_bus_path}/tca9543@73/i2c@0'),
        CameraPlatform.module_fragment(opts, index=5, cam=at(cameras, 4), position='left2',  i2c_bus_number=i2c_bus_number_base + 2, i2c_bus_path=f'{i2c_bus_path}/tca9543@73/i2c@0'),
        CameraPlatform.module_fragment(opts, index=6, cam=at(cameras, 7), position='bottom', i2c_bus_number=i2c_bus_number_base + 3, i2c_bus_path=f'{i2c_bus_path}/tca9543@73/i2c@1'),
        CameraPlatform.module_fragment(opts, index=7, cam=at(cameras, 6), position='top',    i2c_bus_number=i2c_bus_number_base + 3, i2c_bus_path=f'{i2c_bus_path}/tca9543@73/i2c@1'),
    ]
    
    use_reduced_lane_speed = camera.Type.C1MP in opts.camera_list
    max_lane_speed = 1500000 if use_reduced_lane_speed else 2500000
    tegra_camera_platform_fragments = sum(tegra_camera_platform_modules, [
        CameraPlatform.node_fragment(opts, num_csi_lanes=TOTAL_CSI_LANES, max_lane_speed=max_lane_speed)
    ])
    ...
    (root
        ...
        .nodes([
            ...
            # Mux 1 @ 0x72
            FragmentNode(target_path=i2c_bus_path)
                .overlay_nodes([
                    DeviceTreeNode('tca9543@72')
                        .properties([
                            'status = "okay"',
                        ...
                        .nodes([
                            DeviceTreeNode('i2c@0')
                                ...
                                .nodes([
                                    gmsl_dsers[0]
                                ] + sum(map(lambda cam: cam.to_list(), cameras[0:2]), [])),
                            DeviceTreeNode('i2c@1')
                                ...
                                .nodes([
                                    gmsl_dsers[1]
                                ] + sum(map(lambda cam: cam.to_list(), cameras[2:4]), [])),
                        ])
                ]),
                    ...
                    DeviceTreeNode('tca9543@73')
                        ...
                        .nodes([
                            DeviceTreeNode('i2c@0')
                                ...
                                .nodes([
                                    gmsl_dsers[2]
                                ] + sum(map(lambda cam: cam.to_list(), cameras[4:6]), [])),
                            DeviceTreeNode('i2c@1')
                                .properties([
                                    'status = "okay"',
                                    'reg = <1>',
                                ...
                                .nodes([
                                    gmsl_dsers[3]
                                ] + sum(map(lambda cam: cam.to_list(), cameras[6:8]), [])),
                        ])
                ]),
        ]))
...
def i2c_mux_and_gmsl_dsers(gmsl_dsers: Sequence[DeviceTreeNode]) -> List[FragmentNode]:
    # Corrected GPIO configuration based on otocam_isx021_orig.dts.txt
    # This overwrites the default status and properly defines the gpio-hog
    return ([
                ...
                .overlay_nodes([
                    ...
                    DeviceTreeNode('camera-control-output-low')
                        .properties([
                            ...
                            'gpio-hog',
                            'output-low',
                            'gpios = <0x3e 0x00 0xa0 0x00 0x3b 0x00 0xa1 0x00>',
                            'label = "max0-pwdn", "max1-pwdn", "max2-pwdn", "max3-pwdn"',
                        ])
                ])
        ])
...
if __name__ == '__main__':
    help_desc = 'The Jetson camera devicetree overlay generator for Vecow EAC5000'
