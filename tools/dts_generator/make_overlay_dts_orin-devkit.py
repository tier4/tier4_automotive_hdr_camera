...
def create_gmsl_dser_nodes(use_tier4mp_per_dser: Optional[List[bool]] = None) -> List[DeviceTreeNode]:
    ...
    dser_configs = [
        ('max9296_a', 'dsera', f'reset-gpios = <&gpio 0x3b {const.GPIO_ACTIVE_LOW}>'),
        ('max9296_c', 'dserb', f'reset-gpios = <&gpio 0x3e {const.GPIO_ACTIVE_LOW}>'),
        ('max9296_e', 'dserc', f'reset-gpios = <&gpio 0xa2 {const.GPIO_ACTIVE_LOW}>'),
        ('max9296_g', 'dserd', f'reset-gpios = <&gpio 0xa0 {const.GPIO_ACTIVE_LOW}>'),
    ]
