...
public:
  ...
  static int8_t read(std::string dev_name, uint8_t dev_addr, size_t length, uint8_t* data);
  ...
  static int8_t transfer(std::string dev_name, uint8_t dev_addr, const uint8_t*wdata, uint16_t wlength, uint16_t rlength);
