 ...
 * during device boot, after tier4_max9296_setup_link().
 *
 * @param [in]  dev             The deserializer device handle.
 * @param [in]  s_dev           The sensor device handle.
 *
 ...
 * This function is to be called by the sensor client driver.
 *
 * @note  Both @c tier4_max9296_start_streaming and @c tier4_max9296_stop_streaming
...
/**
 * @brief  Powers on the tier4_max9296 deserializer module.
 *
...
/**
 * @brief  Powers off the tier4_max9296 deserializer module.
 *
