...
def usage():
    ...
    print("**                                                                    **")
    print("**  E.g.                                                              **")
    print("**  > make_overaly_dts_xavier-devkit.py R35.1 C1 C1 C1 C1 C2 C2 C1 C1 **")
    print("**             ( Total number of cameras should be 8 )                **")
    print("** Case2:                                                             **")
    print("**                                                                    **")
    print("**  $> make_overaly_dts_xavier-devkit.py option                       **")
    print("**                                                                    **")
    ...
    print("**                                                                    **")
    print("**           $> make_overaly_dts_xavier-devkit.py R32.5.1 -8 C1       **")
    print("**        2.                                                          **")
    ...
    print("**                                                                    **")
    print("**     E.g.                                                           **")
    print("**       $> make_overaly_dts_xavier-devkit.py R35.1 -4 C1 -2 C2 C1 C2 **")
    print("**                                                                    **")
    print("************************************************************************")
